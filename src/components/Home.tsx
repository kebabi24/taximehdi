...
const Home = () => {
  ...
  return (
    <div className="h-[calc(120vh-5rem)] overflow-hidden">
      <div className="bg-cover bg-[url('assets/hero-002.jpg')] flex bg-center bg-no-repeat h-full w-full container flex flex-wrap p-12 sm:p-4 max-w-screen-2xl py-28">
        <div
